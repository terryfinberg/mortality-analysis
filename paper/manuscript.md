...
The asymmetry runs in the reassuring direction. The primary series we report — WONDER's figures exactly as published — produces the **lowest** ratio of the three, {{DECOMP_PRE_RATIO}}. The alternatives we tested both strengthen the claim rather than weaken it, so the treatment carried through this paper is the least favourable to our own argument.
